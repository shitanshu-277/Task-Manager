      ...
      <div>
        ...
        {this.state.userDetails.hasOwnProperty("_id") ? (
          ...
          >
            ...
            <Modal.Footer>
              ...
              <Button variant="dark" onClick={this.confirmFlight}>
                Confirm
              </Button>
            </Modal.Footer>
          </Modal>
        ...
        {this.props.flight.hasOwnProperty("_id") ? (
          <>
                  ...
                  <table style={{ width: "100%", tableLayout: "fixed" }}>
                    <tbody>
                      <tr>
                        ...
                        <td style={{ fontSize: "1.8rem" }}>12:30</td>
                        <td style={{ fontSize: "1.8rem" }}>
            ...
            <h4 style={{color:"white"}}>Passenger Details</h4>
              ...
              <Card style={{marginTop:"30px"}}>
                <Card.Body>
                  <form onSubmit={handleSubmit(this.onSubmit)}>
                    ...
                    <Button variant="dark" type="submit" style={{marginTop:"20px",marginLeft:"40%",width:"20%"}}>
                      Submit
                    </Button>
                  </form>
                </Card.Body>
